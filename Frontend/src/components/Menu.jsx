...
const Menu = ({ setOpen }) => {
  return (
    <div className="h-screen w-full bg-[#000] text-white flex flex-col justify-center items-center relative">
      <FontAwesomeIcon
        icon={faXmark}
        onClick={()=>setOpen(false)}
        className="text-2xl hover:text-blue-700 absolute top-10 right-10 cursor-pointer"
      />
