    ...
    <div className='min-h-screen w-full pt-5'>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between w-3/4 mx-auto  md:mt-20 gap-10">
        <div className='w-full flex mt-25 flex-col gap-5'>
          <h1 className='text-4xl sm:text-6xl font-bold text-white text-center leading-tight'>
        ...
        <img src="Scroll-White-1.gif" alt="" className='w-40 flex items-center justify-center mx-auto mt-10' />
    </div>
  )
}
